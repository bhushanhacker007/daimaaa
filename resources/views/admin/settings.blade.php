<x-dashboard-layout>
    <x-slot:title>Settings — Admin</x-slot:title>
    <x-slot:heading>Manage Settings</x-slot:heading>
    <x-slot:sidebar>@include('admin._sidebar')</x-slot:sidebar>
    @if(view()->exists('livewire.admin.manage-settings'))
    ...
    @else
        <div class="bg-surface-container-lowest rounded-2xl p-8 text-center">
            ...
            <p class="text-on-surface-variant">Manage Settings — CRUD module</p>
        </div>
    @endif
</x-dashboard-layout>
